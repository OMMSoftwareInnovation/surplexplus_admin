      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary" >
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo site_url('buyercontroller/buyer_registraion'); ?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="name2">Buyer Name <span style="color:red">*</span></label>
  ...
  , confirm_password = document.getElementById("confirm_password");
    ...
    var  cnt=0;
        $('#chk_avail').click(function() 
        {
            ...
            if (name.length >= 3) 
            {
                $.post('<?php echo site_url('buyercontroller/chk_buyer_usr'); ?>', {buyer_username: name}, function(d) {
                    if (d == 1)
                    {
        ...
        $( "#email" ).keyup(function() 
        {
            ...
            {
                var name = $('#email').val();
                $.post('<?php echo site_url('buyercontroller/chk_buyer_email'); ?>', {buyer_email: name}, function(d) 
                {
                    if (d == 1)
                    {
